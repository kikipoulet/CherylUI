...
public static class AnimationHelper
{
    ...
    public static void Vibrate(this Animatable control, TimeSpan duration )
    {
        ...
        new Avalonia.Animation.Animation
        {
            Duration = TimeSpan.FromMilliseconds(75), FillMode = FillMode.Forward,
            Easing = new CubicEaseInOut(),
            IterationCount = new IterationCount((ulong)(count)), PlaybackDirection = PlaybackDirection.Normal, 
            Children =
            {
                new KeyFrame()
                {
    ...
    public static void Animate<T>(this Animatable control, AvaloniaProperty Property,T from, T to,  TimeSpan duration, ulong count = 1 )
    {
        new Avalonia.Animation.Animation
        {
            ...
            Easing = new CubicEaseInOut(),
            IterationCount = new IterationCount(count), PlaybackDirection = PlaybackDirection.Normal, 
            Children =
            {
                new KeyFrame()
                {
